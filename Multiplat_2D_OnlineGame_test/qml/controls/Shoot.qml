...
Item {
    ...
    function shoot() {
        ...
        var offsetX = (Math.cos((rotation+90) * Math.PI / 180))
        var offsetY = (Math.sin((rotation+90) * Math.PI / 180))
        ...
        console.log((36*Math.cos((rotation+90) * Math.PI / 180)))
        console.log((36*Math.sin((rotation+90) * Math.PI / 180)))
        ...
        var startX = (36*Math.cos((rotation) * Math.PI / 180)) + offsetX// + character.x + character.width / 2
        var startY = (36*Math.sin((rotation) * Math.PI / 180)) + offsetY// + character.y + character.height / 2
